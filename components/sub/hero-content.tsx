...
// 👑 VIP ENTERPRISE HERO CONTENT (MOBILE ALIGNMENT & EXTERNAL IMAGE FIXED)
// ============================================================================
// AUTHOR: DrakoXNaeem (Naeem)
// ROLE: Electrical Engineer & Full-Stack Systems Architect
// ============================================================================
// DESCRIPTION:
// - Fixed Mobile Viewport: Adjusted top margins so text remains at the absolute top.
// - Fixed Image Rendering: Using external GitHub Avatar URL to prevent local file errors.
// - Typography Enhanced: DrakoXNaeem and Naeem brand names heavily stylized.
// ============================================================================
...
export const HeroContent = () => {
  return (
    <motion.div
      ...
      className="flex flex-col lg:flex-row items-center justify-between px-5 md:px-12 lg:px-20 mt-20 md:mt-40 w-full z-[50] gap-10 lg:gap-8 max-w-[1600px] mx-auto relative"
    >
      ...
      */}
      <div className="h-full w-full flex flex-col gap-6 justify-center m-auto text-start lg:w-[55%] relative z-[60]">
        ...
        <motion.div
          ...
          className="py-[10px] px-[16px] border border-cyan-500/50 opacity-100 rounded-xl bg-[#030014]/90 backdrop-blur-2xl shadow-[0_0_20px_rgba(6,182,212,0.3)] flex items-center w-fit"
        >
          <SparklesIcon className="text-cyan-400 mr-[10px] h-5 w-5 animate-pulse" />
          <h1 className="text-[11px] md:text-[13px] font-mono tracking-[0.2em] uppercase text-gray-100 font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Naeem</span> // Systems Architect
          </h1>
        </motion.div>

        {/* 🔹 Main Headline Typography (Strictly positioned above background) */}
        <motion.div
        ...
        >
          <span>
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 tracking-wider drop-shadow-[0_0_30px_rgba(6,182,212,0.6)] uppercase">
              DrakoXNaeem.
            </span>
          </span>
        </motion.div>
        ...
        >
          I am <strong className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 font-black tracking-wide text-lg uppercase">Naeem</strong>, pursuing a Diploma in <strong className="text-pink-400 font-bold">Electrical Engineering</strong> at Al-Kabir Institute of Management and Technology in Jamshedpur. I seamlessly blend core hardware electrical logic with advanced software automation. My expertise spans across engineering scalable <strong className="text-purple-400 font-bold">Telegram C2 networks</strong>, backend architectures, and executing precision <strong className="text-cyan-400 font-bold">Python automation via Termux</strong>.
        </motion.p>
      ...
      */}
      ...
      >
        {/* Glow effect carefully placed strictly behind the card */}
        ...
        <div className="relative flex flex-col items-center p-3 rounded-[30px] border border-cyan-500/30 bg-[#030014]/60 backdrop-blur-2xl shadow-[0_0_50px_rgba(112,66,248,0.25)] group hover:border-cyan-400/70 transition-all duration-500 z-10 w-full max-w-[320px] md:max-w-[380px]">
          ...
          {/* 🔹 External Profile Image (No Next.js Image Component used to prevent domain config errors) */}
          <div className="w-full aspect-[4/5] rounded-[20px] overflow-hidden border border-white/10 relative bg-[#030014]">
            {/* Using standard img tag with GitHub Avatar for flawless external loading */}
            <img
              src="https://github.com/nansari7287-sys.png"
              alt="DrakoXNaeem Official Identity"
          ...
          <div className="w-full mt-6 mb-4 flex flex-col items-center justify-center relative z-20">
            <h2 className="text-2xl md:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 drop-shadow-[0_0_15px_rgba(112,66,248,0.9)] tracking-[0.15em] uppercase text-center">
              DrakoXNaeem
            </h2>
